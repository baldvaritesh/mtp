\chapter{Analysis of System Results}
...
Here are some results related with Mumbai Center. Table \ref{AnomaliesReported} shows the result of anomalies reported by our system, with details about anomalies reported by each method. So here First 5 columns corresponds to each method. Column 6 is union of results of first 3 methods and column 7 is union of results of method 4 and 5, as described in table. Column 8 is intersection of results of column 6 and column 7, which is final result of our system.\\
	...
	\hline
	Retail Vs Average    & 471 & 180 & 258 & 300 & 177 & 806 & 362 & 125 \\
	\hline
	Retail Vs Arrival    & 266 & 375 & 353 & 500 & 167 & 835 & 573 & 323 \\
	\hline
	Retail Vs Wholesale  & 322 & 300 & 310 & 300 & 167 & 799 & 367 & 160 \\
	\hline
...
\centering
\begin{tikzpicture}
   \pie[ text = legend ]{32/Traders Nexus or Hoarding, 18/Not Stated, 10/Unseasonal Rainfall, 12/Low Production, 18/Low Supply, 10/Other  }
\end{tikzpicture}
...
\subsection{Graph Based Anomaly Detection}
	...
	\\
	The working of this method is quite complex and can not be generalised. For detailed information go through the paper \cite{nasa}. So we will just represent, how method has performed on the different analysis.\\
	\\
