...
\begin{itemize}
 \item 27-Dec-2010 to 29-Dec-2010 : According to our hypothesis 4, price trends at differnet centers should behave similar. But, here retail price of onion in mumbai took a sharp rise then faced a downfall which was not seen being followed by Delhi. Instead retail prices at Delhi continued to grow. (See Figure \ref{fig:Mumbai_RetailvsAvg_ill1})
	...
	\end{figure}
 \item 17-Oct-2013 to 27-Oct-2013 : 
\end{itemize}
