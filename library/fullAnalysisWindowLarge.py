...
def hypothesisForCenter(numOfFiles, *timeSeriesFileNames):
    ...
    for i,c_list in enumerate(retailList):
        ...
        if(userThreshold):
            if(i==0):
                slopeBasedResult = slopeBased(c_list,False,avgRetailTimeSeries, False,10,False,defaultThresholdCentre1[0], 1)
            elif(i==1):
                slopeBasedResult = slopeBased(c_list,False,avgRetailTimeSeries, False,10,False,defaultThresholdCentre2[0], 1)
            slopeBasedResult = mergeDates(slopeBasedResult)     
            
            # Correlation
            correlationResult = anomaliesFromWindowCorrelationWithConstantlag(c_list,avgRetailTimeSeries,20)
            ...
            # CALL SLOPE BASED
            slopeBasedResult = slopeBased(c_list,False,avgRetailTimeSeries, False,10,True,0, 1)        
            slopeBasedResult = mergeDates(slopeBasedResult)     
    ...
    for i,c_list in enumerate(arrivalList):
        ...
        if(userThreshold):
            # CALL SLOPE BASED
            if(i==0):
                slopeBasedResult = slopeBased(retailList[i],False,c_list, False,10,False,defaultThresholdCentre1[2], -1)
            elif(i==1):
                slopeBasedResult = slopeBased(retailList[i],False,c_list, False,10,False,defaultThresholdCentre2[2], -1)
            slopeBasedResult = mergeDates(slopeBasedResult)
            
            # Correlation
            correlationResult = anomaliesFromWindowCorrelationWithConstantlag(c_list,retailList[i],20,15,False)
            correlationResult = mergeDates(correlationResult)
            ...
            # CALL SLOPE BASED
            slopeBasedResult = slopeBased(retailList[i],False,c_list, False,10,True,0, -1)
            slopeBasedResult = mergeDates(slopeBasedResult)
    ...
    for i,c_list in enumerate(retailList):
        ...
        if(userThreshold):
            # CALL SLOPE BASED
            if(i==0):
                slopeBasedResult = slopeBased(c_list,False,wholesaleList[i], False,10,False,defaultThresholdCentre1[4], 1)
            elif(i==1):
                slopeBasedResult = slopeBased(c_list,False,wholesaleList[i], False,10,False,defaultThresholdCentre2[4], 1)
            slopeBasedResult = mergeDates(slopeBasedResult)     
            
            # Correlation
            correlationResult = anomaliesFromWindowCorrelationWithConstantlag(c_list,wholesaleList[i],20)
            correlationResult = mergeDates(correlationResult)
            ...
            # CALL SLOPE BASED
            slopeBasedResult = slopeBased(c_list,False,wholesaleList[i], False,10,True,0, 1)
            slopeBasedResult = mergeDates(slopeBasedResult)     
    ...
    for i,c_list in enumerate(arrivalList):
        ...
        if(userThreshold):
            # CALL SLOPE BASED
            if(i==0):
                slopeBasedResult = slopeBased(wholesaleList[i],False,c_list, False,10,False,defaultThresholdCentre1[6], -1)
            elif(i==1):
                slopeBasedResult = slopeBased(wholesaleList[i],False,c_list, False,10,False,defaultThresholdCentre2[6], -1)
            slopeBasedResult = mergeDates(slopeBasedResult)
            
            # Correlation
            correlationResult = anomaliesFromWindowCorrelationWithConstantlag(c_list,wholesaleList[i],20,15,False)
            correlationResult = mergeDates(correlationResult)
            ...
            # CALL SLOPE BASED
            slopeBasedResult = slopeBased(wholesaleList[i],False,c_list, False,10,True,0, -1)
            slopeBasedResult = mergeDates(slopeBasedResult)
